...
fit_did_2 <- lm(citation_fw ~ (type + transited)^2 + transited:transited_t + year + t + seniority + year + concepts + transited_t, 
                data = data_did)

fit_did_3 <- lm(novelty_fw ~ (type + transited)^2 + year + seniority + year + t + concepts, 
                data = data_did)

fit_did_4 <- lm(novelty_fw ~ (type + transited)^2 + transited:transited_t + year + t + seniority + concepts + transited_t, 
                data = data_did)
